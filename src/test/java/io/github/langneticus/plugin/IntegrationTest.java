...
public class IntegrationTest {
    ...
    @Test
    public void fails_Label_Too_Short_Using_Gradle_8_3() throws IOException, FailedToCreateDirectoryException {
        final TestOptions testOptions = new TestOptions();
        testOptions.gradleVersion = "8.3";
    ...
    @Test
    public void fails_Label_Starts_With_Number_Using_Gradle_8_3() throws IOException, FailedToCreateDirectoryException {
        final TestOptions testOptions = new TestOptions();
        testOptions.gradleVersion = "8.3";
    ...
    @Test
    public void fails_Empty_Json_Using_Gradle_8_3() throws IOException, FailedToCreateDirectoryException {
        final TestOptions testOptions = new TestOptions();
        testOptions.gradleVersion = "8.3";
    ...
    @Test
    public void fails_Malformed_Json_Using_Gradle_8_3() throws IOException, FailedToCreateDirectoryException {
        final TestOptions testOptions = new TestOptions();
        testOptions.gradleVersion = "8.3";
